// Applies the branded Kolek email templates (email-templates/*.html) to the
...
const body = {
  mailer_subjects_confirmation: 'Confirm your Kolek account',
  mailer_templates_confirmation_content: read('confirmation.html'),
  mailer_subjects_recovery: 'Reset your Kolek password',

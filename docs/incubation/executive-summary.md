...
1. **12% marketplace take rate** once in-app payment rails (PayMongo/GCash) launch — ₱18 on an average ₱150 bounty, earned by instant payout and payment guarantee.
2. **Barangay/LGU SaaS** (₱1,500–5,000/mo): waste-hotspot heatmaps, certified-collector roster, RA 9003-aligned reports — a certified cleanup workforce plus governance data, without expanding the municipal payroll.
...
**Impact.** SDG 8 (informal labor → credentialed profession), SDG 11 (cleaner barangays), SDG 12 (source segregation via waste-type tagging); hotspot data as a governance dividend for LGUs.

**The ask.** **₱4.85M over 18 months** (within the DOST SGF ₱5M ceiling): identity verification → payment rails → one-city LGU pilot (20 barangay subscriptions, 8,000 pickups, 200 active collectors) → TESDA-linked certification. Plus incubator support: B2G mentorship, LGU/TESDA introductions, legal clinic, co-founder matching.

**Team.** [FILL IN — founder background; if solo: solo technical founder who shipped the production-grade marketplace end-to-end.]

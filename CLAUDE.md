...
**Presence subsystem:** Collectors explicitly toggle their availability in the HomeFeed. While online with the app open, the client sends location heartbeats to update the `collector_presence` table. Only collectors marked as online and within range receive dispatch pings.
